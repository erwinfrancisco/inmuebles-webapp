...
$municipios2  = array('Matamoros'=>'matamoros','Méndez'=>'mendez','Mier'=>'mier','Miguel Alemán'=>'miguel-aleman','Miquihuana'=>'miquihuana','Nuevo Laredo'=>'nuevo-laredo','Nuevo Morelos'=>'nuevo-morelos','Ocampo'=>'ocampo','Padilla'=>'padilla','Palmillas'=>'palmillas','Reynosa'=>'reynosa','Río Bravo'=>'rio-bravo','San Carlos'=>'san-carlos','San Fernando'=>'san-fernando','San Nicolás'=>'san-nicolas','Soto la Marina'=>'soto-la-marina','Tampico'=>'tampico','Tula'=>'tula','Valle Hermoso'=>'valle-hermoso','Victoria'=>'victoria','Villagrán'=>'villagran','Xicoténcatl'=>'xicotencatl');
...
function municipios1(){
    foreach ($GLOBALS["municipios1"] as $key => $value){
        ...
        echo "<a class='enlace-municipio' href='municipios.php?municipio=" . $value . "'>" . "<div class='nombre-municipio-btn'" . "id='btn__" . $value . "'><tr><span class='municipio-texto-btn'>". $key . "</span></tr></div></a>";
        //echo "</a>";
