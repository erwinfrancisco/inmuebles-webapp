...
if(isset($_REQUEST['fiscalia-nuevo-laredo'])){
    echo "<h1>estas en nuevo laredo</h1>";
}elseif(isset($_REQUEST['fiscalia-matamoros'])){
    echo "<h1>estas en matamoros</h1>";
}elseif(isset($_REQUEST['fiscalia-reynosa'])){
    echo "<h1>estas en reynosa</h1>";
}elseif(isset($_REQUEST['fiscalia-victoria'])){
    echo "<h1>estas en victoria</h1>";
}elseif(isset($_REQUEST['fiscalia-el-mante'])){
    echo "<h1>estas en mante</h1>";
}elseif(isset($_REQUEST['fiscalia-zona-sur'])){
